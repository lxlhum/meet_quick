            ...
            switch (message.Event) {
                case "subscribe": {
                    ...
                    (async () => {
                        ...
                        console.log(err);
                        res.reply('育儿既育己，终于遇见你！真正的教育应该是一场修行，是孩子的纯真、无私、灵动洗濯了成人的浮躁、功力、自大的心理历程。父母通过孩子这面镜子，不断发现自我、修正自我、挖掘自我，并用新我来为孩子做示范和表率。我们是在教育孩子的过程中，遇见了更好的自己。在最合适的年龄给予孩子最适当的教育！在米特，遇见正面管教，遇见美好的自己、孩子和家庭；');
                    })
